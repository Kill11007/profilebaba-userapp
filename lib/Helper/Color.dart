...
class colors {
  ...
  static Color  fontColor = const Color(0xff4543C1);
  ...
  static Color get lightBlack => const Color(0xff52575C);


  static Color get lightBlack2 => const Color(0xff999999);


  static Color get lightWhite => const Color(0xffEEF2F9);
